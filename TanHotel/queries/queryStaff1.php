...
<body>
	...
	try {
		...
		print "<h1>Food order for room: $input</h1>\n";
		...
		$query = "SELECT food.type, food.rate as cost, orders.quantity as qty, room.room_number, orders.guest_id as guestid ".
		"FROM food JOIN orders JOIN room ".
		"WHERE orders.guest_id =room.guest_id ".
		"AND food.food_id = orders.food_id ".
		"AND room.room_number = :input";
